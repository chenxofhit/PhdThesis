...
% 经过十余年的发展,系统生物学使生命科学由描述式的科学转变为定量描述和预测的科学,己在预测医学、预防医学和个性化医学中得到应用,如用生物指纹预测病人的危险
% 程度、疾病的诊断、治疗过程的监控等;用基因多态性图谱预测病人对药物的反应,毒副作用和疗效的诊断等;
% 另外,系统生物学己用于新药的研发,新能源的开发,如海藻炼油等。
% 系统生物学将不仅推动生命科学和生物技术的发展,而且对整个国民经济、社会和人类本身产生重大和深远的影响\cite{ideker2001integrated}。
...
关联网络通常选择皮尔森相关系数或者互信息来定义基因之间的相似性, 具体定义如下：
\begin{enumerate}
\item 
皮尔逊相关系数~(PCC)
...
~Cooper等提出的~K2~算法\cite{cooper1992bayesian}
