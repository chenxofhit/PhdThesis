...
在基因调控网络构建中我们将主要使用~DNA~微阵列数据~(microarray data)~和单细胞~RNA-seq~数据~(scRNA-seq),同时也会结合其它比如~PPI~数据,~TF~结合位点数据等作为先验知识。
...
下面针对关联网络、布尔网络、微分方程、贝叶斯网络、动态贝叶斯网络、回归方法的主要思想，各类型方法的优缺点以及研究进展做简要介绍。
