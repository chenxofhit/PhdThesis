...
单细胞细胞下采样的方法除了常见的随机采样外，还有按照细胞类型占比等比例采样方法~\cite{sinha2018dropclust},
...
按照~0.05\%~的比例随机采样, 抽取了~2623~个细胞,按照模型选择的准则操作后,
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.95\textwidth]{GEP6.key_regulators.tsv.cs.png}
    \caption{
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.95\textwidth]{GEP8.key_regulators.tsv.cs.png}
    \caption{
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.95\textwidth]{GEP14.key_regulators.tsv.cs.png}
    \caption{
