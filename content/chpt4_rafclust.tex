...
据报道,巨核细胞只占整个细胞集总数目的 0.3\% \upcite{zheng2017massively}。
...
\begin{figure*}[!htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{DoRCSummaryPlus.pdf}
    \caption{
...
C4、C5、C9 和 C11 完全由树突状细胞组成,根据 Zheng 等人提供 \upcite{zheng2017massively}的标注,
...
\begin{table}[!htbp]
    ...
    \caption{
        ...
        树突状细胞类型对应于 Villani 报告的细胞类别 \upcite{villani2017single}
        }
...
本文通过不断变化输入单细胞数据规模的大小, 也就是从 1k 到 ${\sim} 68$k 逐渐改变细胞的数目, 
